  ...
  const fetchPropertyData = async () => {
    try {
      ...
      setFormData({
        ...
        agent_commission_months: data.agent_commission_months || '',
        price_per_day: data.price_per_day || '',
        price_negotiable: data.price_negotiable || false,
        has_refundable_caution: data.has_refundable_caution || false,
        has_security_alarm: data.has_security_alarm || false,
        has_wifi: data.has_wifi || false,
        has_backup_power: data.has_backup_power || false,
        commercial_space_usage: data.commercial_space_usage || '',
        suitable_for_what: data.suitable_for_what || '',
        has_front_desk: data.has_front_desk || false,
        ...
        requires_contract_registration: data.requires_contract_registration || false,

        // For Sale specific
        land_size_sqm: data.land_size_sqm || '',
        has_land_title: data.has_land_title || false,
        land_title_type: data.land_title_type || '',
        cadastral_id: data.cadastral_id || '',
        other_documentation: data.other_documentation || '',

        // Land specific
        land_type: data.land_type || '',
        area_characteristics: data.area_characteristics || '',

        // Warehouse specific
        warehouse_height: data.warehouse_height || '',
        has_forklift: data.has_forklift || false,
        allows_truck_entry: data.allows_truck_entry || false,
      })
